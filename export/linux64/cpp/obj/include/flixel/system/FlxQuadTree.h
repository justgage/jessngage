...
class HXCPP_CLASS_ATTRIBUTES  FlxQuadTree_obj : public ::flixel::util::FlxRect_obj{
	...
	public:
		...
		static ::flixel::_system::FlxList _iterator;
		...
		bool exists;
		bool _canSubdivide;
		::flixel::_system::FlxList _headA;
		::flixel::_system::FlxList _tailA;
		::flixel::_system::FlxList _headB;
		::flixel::_system::FlxList _tailB;
