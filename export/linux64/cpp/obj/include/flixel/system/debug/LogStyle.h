...
class HXCPP_CLASS_ATTRIBUTES  LogStyle_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="flixel.system.debug.LogStyle")
		...
		static void __boot();
		static ::flixel::_system::debug::LogStyle NORMAL;
		static ::flixel::_system::debug::LogStyle WARNING;
		static ::flixel::_system::debug::LogStyle ERROR;
		static ::flixel::_system::debug::LogStyle NOTICE;
		static ::flixel::_system::debug::LogStyle CONSOLE;
		::String prefix;
		::String color;
		int size;
		bool bold;
