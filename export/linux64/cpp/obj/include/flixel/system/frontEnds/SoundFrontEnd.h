...
class HXCPP_CLASS_ATTRIBUTES  SoundFrontEnd_obj : public hx::Object{
	...
	public:
		...
		virtual ::flixel::_system::FlxSound load( Dynamic EmbeddedSound,hx::Null< Float >  Volume,hx::Null< bool >  Looped,hx::Null< bool >  AutoDestroy,hx::Null< bool >  AutoPlay,::String URL,Dynamic OnComplete);
		Dynamic load_dyn();

		virtual ::openfl::_legacy::media::Sound cache( ::String EmbeddedSound);
		Dynamic cache_dyn();

		virtual ::flixel::_system::FlxSound play( ::String EmbeddedSound,hx::Null< Float >  Volume,hx::Null< bool >  Looped,hx::Null< bool >  AutoDestroy,Dynamic OnComplete);
		Dynamic play_dyn();

		virtual ::flixel::_system::FlxSound stream( ::String URL,hx::Null< Float >  Volume,hx::Null< bool >  Looped,hx::Null< bool >  AutoDestroy,Dynamic OnComplete);
		Dynamic stream_dyn();
