...
class HXCPP_CLASS_ATTRIBUTES  DebuggerFrontEnd_obj : public hx::Object{
	...
	public:
		...
		bool visible;
		virtual Void setLayout( ::flixel::_system::debug::DebuggerLayout Layout);
		Dynamic setLayout_dyn();

		virtual Void resetLayout( );
		Dynamic resetLayout_dyn();

		virtual ::flixel::_system::ui::FlxSystemButton addButton( ::flixel::_system::debug::ButtonAlignment Alignment,::openfl::_legacy::display::BitmapData Icon,Dynamic UpHandler,hx::Null< bool >  ToggleMode,hx::Null< bool >  UpdateLayout);
		Dynamic addButton_dyn();

		virtual ::flixel::_system::debug::Window track( Dynamic Object,::String WindowTitle);
		Dynamic track_dyn();

		virtual Void addTrackerProfile( ::flixel::_system::debug::TrackerProfile Profile);
