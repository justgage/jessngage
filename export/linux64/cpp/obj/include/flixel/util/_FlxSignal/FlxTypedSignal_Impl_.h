...
class HXCPP_CLASS_ATTRIBUTES  FlxTypedSignal_Impl__obj : public hx::Object{
	...
	public:
		...
		static Void add( ::flixel::interfaces::IFlxSignal this1,Dynamic listener);
		static Dynamic add_dyn();

		static Void addOnce( ::flixel::interfaces::IFlxSignal this1,Dynamic listener);
		static Dynamic addOnce_dyn();

		static Void remove( ::flixel::interfaces::IFlxSignal this1,Dynamic listener);
		static Dynamic remove_dyn();

		static bool has( ::flixel::interfaces::IFlxSignal this1,Dynamic listener);
		static Dynamic has_dyn();

		static Void removeAll( ::flixel::interfaces::IFlxSignal this1);
		static Dynamic removeAll_dyn();

		static Dynamic get_dispatch( ::flixel::interfaces::IFlxSignal this1);
		static Dynamic get_dispatch_dyn();

		static ::flixel::util::_FlxSignal::FlxSignal0 toSignal0( ::flixel::interfaces::IFlxSignal signal);
		static Dynamic toSignal0_dyn();

		static ::flixel::util::_FlxSignal::FlxSignal1 toSignal1( ::flixel::interfaces::IFlxSignal signal);
		static Dynamic toSignal1_dyn();

		static ::flixel::util::_FlxSignal::FlxSignal2 toSignal2( ::flixel::interfaces::IFlxSignal signal);
		static Dynamic toSignal2_dyn();

		static ::flixel::util::_FlxSignal::FlxSignal3 toSignal3( ::flixel::interfaces::IFlxSignal signal);
		static Dynamic toSignal3_dyn();

		static ::flixel::util::_FlxSignal::FlxSignal4 toSignal4( ::flixel::interfaces::IFlxSignal signal);
