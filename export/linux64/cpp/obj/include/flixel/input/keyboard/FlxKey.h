...
class HXCPP_CLASS_ATTRIBUTES  FlxKey_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="flixel.input.keyboard.FlxKey")
		...
		::String __ToString() const { return HX_HCSTRING("FlxKey","\x6d","\xc4","\xcc","\x7b"); }
