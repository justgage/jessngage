...
class HXCPP_CLASS_ATTRIBUTES  FlxTypedSpriteGroup_obj : public ::flixel::FlxSprite_obj{
	...
	public:
		...
		virtual Void multiTransformChildren_Float( cpp::ArrayBase FunctionArray,Array< Float > ValueArray);
		...
		virtual ::flixel::FlxSprite recycle( ::hx::Class ObjectClass,cpp::ArrayBase ContructorArgs,hx::Null< bool >  Force);
		Dynamic recycle_dyn();
		...
		virtual cpp::ArrayBase get_members( );
