...
class HXCPP_CLASS_ATTRIBUTES  Context3D_obj : public hx::Object{
	...
	public:
		...
		virtual Void __deleteTexture( ::openfl::display3D::textures::TextureBase texture);
		Dynamic __deleteTexture_dyn();

		virtual Void __deleteVertexBuffer( ::openfl::display3D::VertexBuffer3D buffer);
		Dynamic __deleteVertexBuffer_dyn();

		virtual Void __deleteIndexBuffer( ::openfl::display3D::IndexBuffer3D buffer);
		Dynamic __deleteIndexBuffer_dyn();

		virtual Void __deleteProgram( ::openfl::display3D::Program3D program);
		Dynamic __deleteProgram_dyn();
