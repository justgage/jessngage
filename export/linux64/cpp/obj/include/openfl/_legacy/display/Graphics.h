...
class HXCPP_CLASS_ATTRIBUTES  Graphics_obj : public hx::Object{
	...
	public:
		...
		virtual Void copyFrom( ::openfl::_legacy::display::Graphics sourceGraphics);
		...
		virtual Void drawGraphicsDatum( ::openfl::_legacy::display::IGraphicsData graphicsDatum);
		...
		virtual Void drawTriangles( Array< Float > vertices,Array< int > indices,Array< Float > uvtData,::openfl::_legacy::display::TriangleCulling culling,Array< int > colors,hx::Null< int >  blendMode);
