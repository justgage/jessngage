...
class HXCPP_CLASS_ATTRIBUTES  __ASSET__assets_fonts_nokiafc22_ttf_obj : public ::openfl::_legacy::text::Font_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="__ASSET__assets_fonts_nokiafc22_ttf")
		...
		::String __ToString() const { return HX_HCSTRING("__ASSET__assets_fonts_nokiafc22_ttf","\xdf","\xc5","\x21","\x04"); }
