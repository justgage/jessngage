...
{  hx::ObjectPtr< FlxKeyList_obj > _result_ = new FlxKeyList_obj();
	_result_->__construct(CheckStatus);
	return _result_;}
...
bool FlxKeyList_obj::get_A( ){
	...
	HX_STACK_LINE(19)
	int tmp1 = this->checkStatus;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(19)
...
bool FlxKeyList_obj::get_ANY( ){
	...
	while((true)){
		...
		HX_STACK_LINE(122)
		::flixel::input::keyboard::FlxKey tmp4 = tmp3->_keyList->__get(keyCode).StaticCast< ::flixel::input::keyboard::FlxKey >();		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(122)
		key = tmp4;
		HX_STACK_LINE(123)
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(125)
			int tmp8 = this->checkStatus;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(125)
			bool tmp9 = tmp6->checkStatus(tmp7,tmp8);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(125)
			if ((tmp9)){
				HX_STACK_LINE(127)
				return true;
...
bool FlxKeyList_obj::check( int keyCode){
	HX_STACK_FRAME("flixel.input.keyboard.FlxKeyList","check",0x30337fb6,"flixel.input.keyboard.FlxKeyList.check","flixel/input/keyboard/FlxKeyList.hx",136,0xb04d5f03)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(137)
	int tmp2 = this->checkStatus;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(137)
...
Dynamic FlxKeyList_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"NUMPADSLASH") ) { if (inCallProp == hx::paccAlways) return get_NUMPADSLASH(); }
...
Dynamic FlxKeyList_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 11:
...
{
	outFields->push(HX_HCSTRING("checkStatus","\x1a","\xba","\x0d","\xe8"));
	...
	outFields->push(HX_HCSTRING("NUMPADSLASH","\x30","\x62","\xc6","\x2a"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(FlxKeyList_obj,checkStatus),HX_HCSTRING("checkStatus","\x1a","\xba","\x0d","\xe8")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("get_NUMPADSLASH","\xc7","\x19","\xa8","\xeb"),
