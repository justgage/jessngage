...
::String FrameRecord_obj::save( ){
	...
	if ((tmp4)){
		...
		HX_STACK_LINE(83)
		Float tmp6 = tmp5->__Field(HX_HCSTRING("x","\x78","\x00","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(83)
		...
		HX_STACK_LINE(83)
		Float tmp9 = tmp8->__Field(HX_HCSTRING("y","\x79","\x00","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(83)
