...
bool ToggleMode = __o_ToggleMode.Default(false);
{
	...
	if ((tmp)){
		HX_STACK_LINE(57)
		::openfl::_legacy::display::Bitmap tmp1 = ::openfl::_legacy::display::Bitmap_obj::__new(Icon,null(),null());		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(57)
		this->_icon = tmp1;
		HX_STACK_LINE(58)
...
FlxSystemButton_obj::operator ::flixel::interfaces::IFlxDestroyable_obj *()
...
Void FlxSystemButton_obj::changeIcon( ::openfl::_legacy::display::BitmapData Icon){
{
		...
		HX_STACK_LINE(86)
		::openfl::_legacy::display::Bitmap tmp2 = ::openfl::_legacy::display::Bitmap_obj::__new(Icon,null(),null());		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(86)
		this->_icon = tmp2;
		HX_STACK_LINE(87)
		::openfl::_legacy::display::Bitmap tmp3 = this->_icon;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(87)
		this->addChild(tmp3);
	}
return null();
...
{
		HX_STACK_FRAME("flixel.system.ui.FlxSystemButton","onMouseUp",0xe1786b39,"flixel.system.ui.FlxSystemButton.onMouseUp","flixel/system/ui/FlxSystemButton.hx",101,0x167fa379)
		HX_STACK_THIS(this)
		HX_STACK_ARG(E,"E")
		HX_STACK_LINE(102)
