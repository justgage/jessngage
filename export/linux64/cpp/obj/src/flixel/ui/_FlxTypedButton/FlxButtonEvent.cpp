...
{
HX_STACK_FRAME("flixel.ui._FlxTypedButton.FlxButtonEvent","new",0xcc3151b5,"flixel.ui._FlxTypedButton.FlxButtonEvent.new","flixel/ui/FlxTypedButton.hx",402,0x752be24c)
HX_STACK_THIS(this)
...
FlxButtonEvent_obj::operator ::flixel::interfaces::IFlxDestroyable_obj *()
	{ return new ::flixel::interfaces::IFlxDestroyable_delegate_< FlxButtonEvent_obj >(this); }
Void FlxButtonEvent_obj::destroy( ){
{
		HX_STACK_FRAME("flixel.ui._FlxTypedButton.FlxButtonEvent","destroy",0x44c77ccf,"flixel.ui._FlxTypedButton.FlxButtonEvent.destroy","flixel/ui/FlxTypedButton.hx",414,0x752be24c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(415)
		this->callback = null();
		HX_STACK_LINE(418)
...
{
		HX_STACK_FRAME("flixel.ui._FlxTypedButton.FlxButtonEvent","fire",0xd9af7cc1,"flixel.ui._FlxTypedButton.FlxButtonEvent.fire","flixel/ui/FlxTypedButton.hx",426,0x752be24c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(427)
...
void FlxButtonEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.ui._FlxTypedButton.FlxButtonEvent","\x43","\x53","\xf7","\x0f");
