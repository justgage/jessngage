...
Void FlxState_obj::resetSubState( ){
{
		...
		if ((tmp4)){
			...
			if ((tmp6)){
				...
				HX_STACK_LINE(108)
				tmp7->__Field(HX_HCSTRING("reset","\xcf","\x49","\xc8","\xe6"), hx::paccDynamic )();
			}
			HX_STACK_LINE(111)
...
int FlxState_obj::get_bgColor( ){
	HX_STACK_FRAME("flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",170,0xdf96844c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(171)
...
int FlxState_obj::set_bgColor( int Value){
	HX_STACK_FRAME("flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",175,0xdf96844c)
	HX_STACK_THIS(this)
