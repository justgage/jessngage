...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","add",0x0a4ba52c,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.add","flixel/util/FlxSignal.hx",20,0x3c758c5e)
...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","addOnce",0x33af54cd,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.addOnce","flixel/util/FlxSignal.hx",25,0x3c758c5e)
		HX_STACK_ARG(this1,"this1")
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(26)
		Dynamic tmp = listener;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","remove",0xc99e2219,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.remove","flixel/util/FlxSignal.hx",30,0x3c758c5e)
		HX_STACK_ARG(this1,"this1")
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(31)
		Dynamic tmp = listener;		HX_STACK_VAR(tmp,"tmp");
...
bool FlxTypedSignal_Impl__obj::has( ::flixel::interfaces::IFlxSignal this1,Dynamic listener){
	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","has",0x0a50f265,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.has","flixel/util/FlxSignal.hx",35,0x3c758c5e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(36)
	Dynamic tmp = listener;		HX_STACK_VAR(tmp,"tmp");
...
Dynamic FlxTypedSignal_Impl__obj::get_dispatch( ::flixel::interfaces::IFlxSignal this1){
	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","get_dispatch",0x56609658,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.get_dispatch","flixel/util/FlxSignal.hx",45,0x3c758c5e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(46)
...
::flixel::util::_FlxSignal::FlxSignal0 FlxTypedSignal_Impl__obj::toSignal0( ::flixel::interfaces::IFlxSignal signal){
	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal0",0xbcacb1d8,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal0","flixel/util/FlxSignal.hx",51,0x3c758c5e)
...
::flixel::util::_FlxSignal::FlxSignal1 FlxTypedSignal_Impl__obj::toSignal1( ::flixel::interfaces::IFlxSignal signal){
	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal1",0xbcacb1d9,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal1","flixel/util/FlxSignal.hx",57,0x3c758c5e)
	HX_STACK_ARG(signal,"signal")
	HX_STACK_LINE(58)
...
::flixel::util::_FlxSignal::FlxSignal2 FlxTypedSignal_Impl__obj::toSignal2( ::flixel::interfaces::IFlxSignal signal){
	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal2",0xbcacb1da,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal2","flixel/util/FlxSignal.hx",63,0x3c758c5e)
	HX_STACK_ARG(signal,"signal")
	HX_STACK_LINE(64)
...
::flixel::util::_FlxSignal::FlxSignal3 FlxTypedSignal_Impl__obj::toSignal3( ::flixel::interfaces::IFlxSignal signal){
	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal3",0xbcacb1db,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal3","flixel/util/FlxSignal.hx",69,0x3c758c5e)
	HX_STACK_ARG(signal,"signal")
	HX_STACK_LINE(70)
...
::flixel::util::_FlxSignal::FlxSignal4 FlxTypedSignal_Impl__obj::toSignal4( ::flixel::interfaces::IFlxSignal signal){
	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal4",0xbcacb1dc,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal4","flixel/util/FlxSignal.hx",75,0x3c758c5e)
	HX_STACK_ARG(signal,"signal")
	HX_STACK_LINE(76)
