...
bool FlxRandom_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"_red") ) { _red=ioValue.Cast< int >(); return true; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"_blue") ) { _blue=ioValue.Cast< int >(); return true; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"_green") ) { _green=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"_alpha") ) { _alpha=ioValue.Cast< int >(); return true; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"globalSeed") ) { if (inCallProp == hx::paccAlways)  ioValue = set_globalSeed(ioValue); else globalSeed=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"_intHelper") ) { _intHelper=ioValue.Cast< int >(); return true; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"_intHelper2") ) { _intHelper2=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"_intHelper3") ) { _intHelper3=ioValue.Cast< int >(); return true; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_floatHelper") ) { _floatHelper=ioValue.Cast< Float >(); return true; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_internalSeed") ) { _internalSeed=ioValue.Cast< int >(); return true; }
		break;
	case 17:
