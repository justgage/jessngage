...
bool FlxAngle_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"cosTable") ) { cosTable=ioValue.Cast< Array< Float > >(); return true; }
		if (HX_FIELD_EQ(inName,"sinTable") ) { sinTable=ioValue.Cast< Array< Float > >(); return true; }
	}
	return false;
}
...
void FlxAngle_obj::__register()
{
	...
	__mClass->mSetStaticField = &FlxAngle_obj::__SetStatic;
