...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("HaxeFlixel","\x42","\x8f","\x0c","\xac"),HX_HCSTRING("HelloWorld","\x00","\x76","\xb5","\xbd"),HX_HCSTRING("com.example.myapp","\x84","\x30","\x57","\xc1"),HX_HCSTRING("0.0.1","\x35","\x3d","\xc8","\xc1"));
		HX_STACK_LINE(133)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",52,0x0780ded5)
			{
				...
				{
					HX_STACK_LINE(87)
					::String tmp29 = ::Sys_obj::getCwd();		HX_STACK_VAR(tmp29,"tmp29");
					HX_STACK_LINE(87)
					::String tmp30 = (tmp29 + HX_HCSTRING("/lime-legacy.ndll","\x32","\xba","\x8e","\x27"));		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(87)
					bool tmp31 = ::sys::FileSystem_obj::exists(tmp30);		HX_STACK_VAR(tmp31,"tmp31");
					HX_STACK_LINE(87)
					bool tmp32 = !(tmp31);		HX_STACK_VAR(tmp32,"tmp32");
					HX_STACK_LINE(87)
					if ((tmp32)){
						HX_STACK_LINE(89)
						::String tmp33 = ::Sys_obj::executablePath();		HX_STACK_VAR(tmp33,"tmp33");
						HX_STACK_LINE(89)
						::String tmp34 = ::haxe::io::Path_obj::directory(tmp33);		HX_STACK_VAR(tmp34,"tmp34");
						HX_STACK_LINE(89)
						::Sys_obj::setCwd(tmp34);
					}
				}
				}
				catch(Dynamic __e){
