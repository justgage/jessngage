...
bool TextFormatAlign_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
...
void TextFormatAlign_obj::__register()
{
	...
	__mClass->mSetStaticField = &TextFormatAlign_obj::__SetStatic;
