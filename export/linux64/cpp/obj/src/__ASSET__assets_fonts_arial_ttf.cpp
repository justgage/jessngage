...
{
HX_STACK_FRAME("__ASSET__assets_fonts_arial_ttf","new",0xb1704c75,"__ASSET__assets_fonts_arial_ttf.new","DefaultAssetLibrary.hx",526,0x0fc48912)
HX_STACK_THIS(this)
...
bool __ASSET__assets_fonts_arial_ttf_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
...
bool __ASSET__assets_fonts_arial_ttf_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
...
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsString,(void *) &__ASSET__assets_fonts_arial_ttf_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void __ASSET__assets_fonts_arial_ttf_obj::__register()
{
	...
	__mClass->mGetStaticField = &__ASSET__assets_fonts_arial_ttf_obj::__GetStatic;
	__mClass->mSetStaticField = &__ASSET__assets_fonts_arial_ttf_obj::__SetStatic;
...
{
	resourceName= HX_HCSTRING("NME_font___ASSET__assets_fonts_arial_ttf","\x4c","\xff","\x9e","\xff");
}
