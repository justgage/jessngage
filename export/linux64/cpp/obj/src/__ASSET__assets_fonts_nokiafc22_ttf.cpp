...
{
HX_STACK_FRAME("__ASSET__assets_fonts_nokiafc22_ttf","new",0x9dff4251,"__ASSET__assets_fonts_nokiafc22_ttf.new","DefaultAssetLibrary.hx",525,0x0fc48912)
HX_STACK_THIS(this)
...
bool __ASSET__assets_fonts_nokiafc22_ttf_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
...
void __ASSET__assets_fonts_nokiafc22_ttf_obj::__register()
{
	...
	__mClass->mSetStaticField = &__ASSET__assets_fonts_nokiafc22_ttf_obj::__SetStatic;
