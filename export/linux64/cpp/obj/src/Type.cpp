...
::String Type_obj::getEnumName( ::Enum e){
	HX_STACK_FRAME("Type","getEnumName",0x9b42910e,"Type.getEnumName","/usr/share/haxe/std/cpp/_std/Type.hx",62,0x978d9ce0)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(63)
...
Array< ::String > Type_obj::getInstanceFields( ::hx::Class c){
	HX_STACK_FRAME("Type","getInstanceFields",0xe970f890,"Type.getInstanceFields","/usr/share/haxe/std/cpp/_std/Type.hx",101,0x978d9ce0)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(101)
...
::ValueType Type_obj::_typeof( Dynamic v){
	HX_STACK_FRAME("Type","typeof",0xd6c51d65,"Type.typeof","/usr/share/haxe/std/cpp/_std/Type.hx",112,0x978d9ce0)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(113)
