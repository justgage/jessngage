...
@:font("/home/justgage/haxelib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("/home/justgage/haxelib/flixel/3,3,11/assets/fonts/arial.ttf") @:keep #if display private #end class __ASSET__assets_fonts_arial_ttf extends flash.text.Font {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/backgroud.xcf", AssetType.BINARY);
		path.set ("assets/images/jess-run.png", "assets/images/jess-run.png");
		type.set ("assets/images/jess-run.png", AssetType.IMAGE);
		path.set ("assets/images/gage-stand.png", "assets/images/gage-stand.png");
		type.set ("assets/images/gage-stand.png", AssetType.IMAGE);
		path.set ("assets/images/ground-tiles.png", "assets/images/ground-tiles.png");
		type.set ("assets/images/ground-tiles.png", AssetType.IMAGE);
		...
		type.set ("assets/data/basic-level.tmx", AssetType.TEXT);
		path.set ("assets/data/basic-level.", "assets/data/basic-level.");
		type.set ("assets/data/basic-level.", AssetType.TEXT);
		...
		id = "assets/images/backgroud.xcf";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/images/jess-run.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/gage-stand.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/ground-tiles.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/ground.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/jess-bow.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/larf.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/jess-jump.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/jess-stand.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/middle-ground.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/images-go-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/jess-tiles.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/jess.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/jess-tiles.xcf";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/images/jess-arrow.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/gage-jump.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/data/level1.tmx";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/basic-level.tmx";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/basic-level.";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
...
@:font("/home/justgage/haxelib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("/home/justgage/haxelib/flixel/3,3,11/assets/fonts/arial.ttf") #if display private #end class __ASSET__assets_fonts_arial_ttf extends lime.text.Font {}
